...
public class RepresentativeTableItem {
    ...
    public ReadOnlyStringProperty phoneNumbersProperty() {
        String phoneNumber = findPrimaryOrFirst(phoneNumbers);
    ...
    public ReadOnlyStringProperty emailsProperty() {
        String email = findPrimaryOrFirst(emails);
        return new SimpleStringProperty(email);
    }

    private String findPrimaryOrFirst(SimpleObjectProperty<List<Contact>> contacts) {
        return contacts.get()
                .stream()
