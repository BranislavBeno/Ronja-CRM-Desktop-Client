...
public final class ContactDetailDialog extends Dialog<Contact> {
  ...
  public ContactDetailDialog(Contact contact) {
    ...
    contactTextField = new TextField(contact.contact());
    typeTextField = new TextField(contact.type());
    primaryCheckBox = new CheckBox();
    primaryCheckBox.setSelected(contact.primary());
    ...
    this.setResultConverter(button -> {
      if (button.equals(okButtonType)) {
        return new Contact(contactTextField.getText(), typeTextField.getText(), primaryCheckBox.isSelected());
      }
      return null;
    });
  }
